...
// import { fetchBusinessCard } from '../../redux/businessCardSlice'; // Redux 액션
// import { API_ENDPOINTS } from '../../constants/api'; // API URL 상수
...
//     try {
//       const response = await fetch(`${API_ENDPOINTS.BUSINESS_CARDS}/members/${memberId}`, {
//         method: 'POST',
//         headers: {
...
//         await dispatch(fetchBusinessCard(memberId)); // 명함 생성 후 Redux 상태 업데이트
...
//         disabled={!name || !email || !imageFileName}
//       />
//     </View>
//   );
// };
