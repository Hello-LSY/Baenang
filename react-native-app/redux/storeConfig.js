...
import travelCertificatesReducer from '../redux/travelCertificatesSlice'; // travelCertification 리듀서 추가
...
const storeConfig = configureStore({
  reducer: {
    ...
    travelCertificates: travelCertificatesReducer, // travelCertification 리듀서 등록
