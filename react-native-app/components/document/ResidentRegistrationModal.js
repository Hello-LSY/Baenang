      ...
      <Pressable style={styles.backdrop} onPress={onClose}>
        <Pressable style={styles.modalContainer} onPress={(e) => e.stopPropagation()}>
          ...
          <Animated.View style={[styles.modalView, { transform: [{ rotateY }] }]}>
            ...
            {/* 모달 타이틀 - 위치 고정 */}
            <Text style={styles.modalTitle}>{'주민등록증'}</Text>
            <Text style={styles.modalTitleEng}>{"Resident Registration"}</Text>
                  ...
                  <View style={styles.infoContainer}>
                    {isDetailView ? (
                      <View>
                        ...
                        <Text style={styles.textLabel}>주소</Text>
                        <Text style={styles.textDetailInfo}>{residentRegistration.address}</Text>
                        <Text style={styles.textLabel}>발급일</Text>
                        <Text style={styles.textDetailInfo}>{formatDate(residentRegistration.issueDate)}</Text>
                      </View>
                    ) : (
                      <View style={styles.dataContainer}>
                        ...
                        <Text style={styles.textLabel}>주민등록번호</Text>
                        <Text style={styles.textInfo}>{residentRegistration.rrn}</Text>
                      </View>
                    )}
                  </View>
                ) : (
            ...
            {/* Issuer - 하단 고정 */}
            <Text style={styles.textIssuer}>{residentRegistration ? residentRegistration.issuer : ''}</Text>
          </Animated.View>
        </Pressable>
      </Pressable>
    </Modal>
